	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editLogin.setOnFocusChangeListener(new View.OnFocusChangeListener() {
			...
			public void onFocusChange(View v, boolean hasFocus) {
			    if(!hasFocus){
			        if (PlayerRequest.loginExist(RegisterActivity.this, editLogin)) {
		...
		btnValid.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (editLogin.getText().toString().length() < 2
						...
						|| isTrue == false) {
					Toast.makeText(RegisterActivity.this, Const.ERREUR_REGISTER, Toast.LENGTH_LONG).show();
				} else {
					// On enregistre l'utilisateur
					PlayerRequest.register(RegisterActivity.this, editLogin, editPassword);
					
					// On authentifie l'utilisateur
					Player oPlayer1 = PlayerRequest.authentication(RegisterActivity.this,
					...
					if (oPlayer1 != null) {
						...
						Intent intentOpenHome = new Intent(RegisterActivity.this,
								HomeActivity.class);
