...
public class ResultContract {
	...
	public final static String SCHEMA = "CREATE TABLE " + TABLE + "(" + COL_ID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT," + COL_PLAYDATE
			+ " DATETIME NOT NULL, " + COL_ID_GAME
			+ " INTEGER NOT NULL REFERENCES " + GameContract.TABLE + "("
			+ GameContract.COL_ID + ")," + COL_PLAYER1
			+ " INTEGER NOT NULL REFERENCES " + PlayerContract.TABLE + "("
			+ PlayerContract.COL_ID + ")," + COL_PLAYER2
			+ " INTEGER NOT NULL REFERENCES " + PlayerContract.TABLE + "("
			+ PlayerContract.COL_ID + ")," + COL_SCOREP1
			+ " INTEGER NOT NULL, " + COL_SCOREP2 + " INTEGER NOT NULL " + ");";

	// Colonne a récupérer lors d'un GET en base
	public final static String[] COLS = { ResultContract.COL_ID,
			ResultContract.COL_PLAYDATE, ResultContract.COL_ID_GAME,
			ResultContract.COL_PLAYER1, ResultContract.COL_PLAYER2,
			ResultContract.COL_SCOREP1, ResultContract.COL_SCOREP2 };
}
